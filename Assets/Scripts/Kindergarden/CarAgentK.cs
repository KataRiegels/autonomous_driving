...
public class CarAgentK : Agent
{
    ...
    [SerializeField] private float timeLimit = 600.0f;    // Adjusting this, changes the maximum time before resetting the task 
    ...
    public override void OnEpisodeBegin()
    {
        ...
        //closestDistance = Vector3.Distance(transform.position, targetTransform.position);
    ...
    public override void Heuristic(in ActionBuffers actionsOut)
    {
        ...
        //if (Input.GetKeyDown(KeyCode.P)) // Press 'P' to print the reward
        //{
        //    Debug.Log("Check: " + totalDistanceReward);
        //}
    }
